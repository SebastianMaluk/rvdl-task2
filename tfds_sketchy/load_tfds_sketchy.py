...
train_ds, valid_known_ds, valid_unknown_ds = tfds.load("sketchy", split=["train", "validation_known", "validation_unknown"])
# train_ds, valid_known_ds = tfds.load("tfds_sketchy", split=["train", "validation_known"])
